...
<div style="background-color:#EFEFEF;display:block;position:relative;overflow-y:visible;width:100%;min-width:320px;max-width:900px;padding:20px;margin:auto;">
	...
	<div style="background-color:#EFEFEF;padding:0px;margin:auto;overflow-y:visible;width:100%;height:100%;max-width:900px;">
	...
	<div style="background-color:#EFEFEF;padding:0px;overflow-y:visible;width:100%;height:100%;max-width:900px;">
	...
	<div style="background-color:#EFEFEF;padding-top:5px;padding:5px 0px 5px 0px;text-align:left;max-width:900px;">
