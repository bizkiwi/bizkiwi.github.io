...
- Category: Automation
-->
<button class="btn btn-primary" style="position:relative;padding:auto;height:4vh;width:9vw;z-index:1900;display:inline;bottom:2vh;right:1vw;float:right;" data-dismiss="modal" type="button"><i class="fas fa-times"></i>Close Project</button></div>