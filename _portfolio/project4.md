...
<img src="assets/img/portfolio/close-box.png" width="600" height="600" style="position:fixed;display:block;z-index:1400;overflow-x:hidden;overflow-y:hidden;margin:0px;padding:0px;top:0px;right:0px;width:20%;height:20%;" />
