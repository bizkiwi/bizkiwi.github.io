...
---
<div style="position:fixed;display:block;z-index:1300;overflow-x:hidden;overflow-y:hidden;margin:0px;padding:0px;left:0px;top:0px;right:0px;bottom:0px;width:100%;height:100%;">
...
<div style="position:fixed;display:block;z-index:1400;overflow-x:hidden;overflow-y:hidden;margin:0px;padding:0px;left:0px;top:0px;right:0px;bottom:0px;width:100%;height:100%;">
<img src="assets/img/portfolio/close-box.png" width="600" height="600" style="position:fixed;display:block;float:right;z-index:1800;overflow-x:hidden;overflow-y:hidden;margin:0px;padding:0px;top:0px;right:0px;width:600px;height:600px;" />
</div>
